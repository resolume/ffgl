...
static CFFGLPluginInfo PluginInfo(
	...
	"Sample FFGL libCinder plugin",// Plugin description
...
FFResult FFGLCinder::InitGL( const FFGLViewportStruct* vp )
{
...
FFResult FFGLCinder::ProcessOpenGL( ProcessOpenGLStruct* pGL )
{
	float rgb1[ 3 ];
...
FFResult FFGLCinder::SetFloatParameter( unsigned int dwIndex, float value )
{
	switch( dwIndex )
	{
	case FFPARAM_Hue1:
...
float FFGLCinder::GetFloatParameter( unsigned int index )
{
	float retValue = 0.0;
